...
const projects: Project[] = [
  {
    ...
    subtitle: '1,000 candidates sourced, filtered, and personally messaged — in one automated run.',
    color: '#1a1a1a',
    client: null,
    clientNote: 'Built for a senior executive at one of Bahrain\u2019s leading technology firms in the financial services space. Name withheld at the client\u2019s request.',
    highlights: [
    ...
    outcome: '1,000 candidates sourced and messaged per batch — replacing roughly 80+ hours of manual recruiting with a single automated workflow.',
  },
  {
    id: 2,
    tag: 'E-Commerce',
    title: 'Pre-Orders, Shipping & Automation',
    subtitle: 'A complete pre-order system, shipping integration, and workflow automation for a growing e-commerce brand.',
    color: '#f5f0eb',
    client: {
      name: 'Jerar',
    ...
    outcome: 'We\u2019re grateful this turned into a lasting partnership — the client continues to trust us with new projects as we grow together.',
  },
]
...
function ProjectDetail({ project, onClose }: { project: Project; onClose: () => void }) {
  ...
  return (
    <div className="project-overlay" ref={overlayRef}>
      <button className="project-overlay-close" onClick={handleClose} ref={closeRef} aria-label="Close">
            ...
            <div className="project-details-inner">
              ...
              <div className="project-section">
                ...
                {project.client ? (
                  ...
                  <p className="project-section-client-note">{project.clientNote}</p>
                ) : null}
              </div>
            </div>
          </div>
