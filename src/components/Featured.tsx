...
const projects = [
  {
    ...
    image: "https://ral-website.com/assets/projects/puntopago/cover.jpg",
  },
  {
    id: 2,
    name: "DaoWay",
    description: "Astrology planner app: plan, achieve, thrive",
    image: "https://ral-website.com/assets/projects/daoway/cover.jpg",
  },
  {
    id: 3,
    name: "Riyadh",
    description: "Official website of Riyadh, Saudi Arabia's capital",
    image: "https://ral-website.com/assets/projects/riyadh/cover.jpg",
  },
  {
    id: 4,
    name: "Qvino",
    description: "Wine marketplace with interactive learning",
    image: "https://ral-website.com/assets/projects/qvino/cover.jpg",
  },
  {
    id: 5,
    name: "Potion",
    description: "Sales tool for increasing conversions",
    image: "https://ral-website.com/assets/projects/potion/cover.jpg",
  },
  {
    id: 6,
    name: "Cisco",
    description: "Cloud based network management",
    image: "https://ral-website.com/assets/projects/cisco/cover.jpg",
  },
  {
    id: 7,
    name: "Kelvin Zero",
    description: "A digital product for passwordless authentication",
    image: "https://ral-website.com/assets/projects/kzero/cover.jpg",
  },
  {
    id: 8,
    name: "Magma",
    description: "The ultimate tool for building in the Web3 era",
    image: "https://ral-website.com/assets/projects/magma/cover.jpg",
  },
];
